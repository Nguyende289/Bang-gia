                ...
                <div className="bg-red-800/50 backdrop-blur-sm border border-red-500 rounded-xl shadow-2xl p-4 md:p-6 overflow-x-auto">
                    <table className="w-full min-w-max text-left border-collapse">
                        ...
                        <tr className="border-b border-red-500">
                            ...
                            <th key={index} className={`p-5 sm:p-6 font-semibold text-yellow-300 bg-red-700/60 uppercase text-2xl whitespace-nowrap ${index === 0 ? 'text-center' : ''}`}>
                                {headerCell}
                            </th>
                            ))}
                        </tr>
                        ...
                        {sheetData.slice(1).map((row, rowIndex) => (
                            ...
                            {row.map((cell, cellIndex) => (
                                <td key={cellIndex} className={`p-5 sm:p-6 text-red-100 font-serif text-3xl ${cellIndex === 0 ? 'whitespace-normal break-words' : ''}`}>
                                {cell}
                                </td>
                            ))}
                            </tr>
